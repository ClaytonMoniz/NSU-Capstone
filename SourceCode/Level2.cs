...
namespace Shoot_Out_Game
{
    public partial class Level2 : Form
    {
        ...
        private void MainTimerEvent(object sender, EventArgs e)
        {
            ...
            if (score >= 6)//once score is reached key becomes visible and can be collected
            {
                key.Visible = true;
        ...
        private void MakeZombies()//level1 enemy design
        {
        ...
        private void MakeZombiesLvl2()//level2 enemy design
        {
        ...
        {
            for (int i = 0; i < 4; i++)//controls how many of level1 enemies spawn
            {
                MakeZombies();
            }
