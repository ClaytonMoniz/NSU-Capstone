...
1. Go to the [ZombieShooterSetup](ZombieShooterSetup) click on ***Release/ZombieShooterSetup.msi*** Right click on ***Download*** and then ***Save link as*** [Video](https://user-images.githubusercontent.com/118314166/232385213-7b349401-1e53-4270-80bf-662506681746.mp4) for reference. Place in a folder of your choosing repeat for ***Release/setup.exe***.
## Testing Information
